				...
				<div class="container-fluid">
					...
					<div class="card shadow">
						...
						<div class="card-body">
							...
							<div class="modal fade" id="transaction" tabindex="-1" role="dialog" aria-labelledby="label_transaction" aria-hidden="true">
								<div class="modal-dialog modal-dialog-slideout modal-lg" role="document">
								<div class="modal-content">
								<div class="modal-header">
								<h5 class="modal-title" id="label_transaction">Form transaction</h5>
							...
							<div class="form-group">
									<label for="transaction_at">transaction_at</label>
									<input type="datetime" class="form-control" id="transaction_at" name="transaction_at" placeholder="" value="" >
									</div>

							<div class="form-group">
									<label for="ref_no">ref_no</label>
									<input type="text" class="form-control" id="ref_no" name="ref_no" placeholder="" value="" >
									</div>

							<div class="form-group">
									<label for="transfer_in">transfer_in</label>
									<input type="number" class="form-control" id="transfer_in" name="transfer_in" placeholder="" value="" >
									</div>

							<div class="form-group">
									<label for="fee">fee</label>
									<input type="number" class="form-control" id="fee" name="fee" placeholder="" value="" >
									</div>

							<div class="form-group">
									<label for="net_balance">net_balance</label>
									<input type="number" class="form-control" id="net_balance" name="net_balance" placeholder="" value="" >
									</div>

							<div class="form-group">
									<label for="status">status</label>
									<input type="number" class="form-control" id="status" name="status" placeholder="" value="" >
									</div>
							</form>
